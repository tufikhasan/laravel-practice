...
@section('content')
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="header01">
                <ul class="navbar-nav ms-auto mt-3 mt-lg-0 mb-3 mb-lg-0 me-4">
                    @auth
                        <li><a class="link-secondary me-4" href="{{ url('/dashboard') }}">Dashboard</a></li>
                    @else
                        <li><a class="link-secondary me-4" href="{{ route('login') }}">Log in</a></li>
                        @if (Route::has('register'))
                            <li><a class="link-secondary me-4" href="{{ route('register') }}">Register</a></li>
                        @endif
                    @endauth
                </ul>
            ...
            <div class="row align-items-center mb-5">
                <div class="col-12 col-md-10 col-lg-5 mb-5 mb-lg-0">
                    ...
                    <p class="lead text-muted mb-4">Discover streamlined transactions, real-time inventory management,
                        and actionable insights in one intuitive POS app.</p>
                    <div class="d-flex flex-wrap"><a class="btn bg-gradient-primary me-2 mb-2 mb-sm-0"
                            href="{{ url('/userLogin') }}">Start Sale</a>
                        <a class="btn bg-gradient-primary mb-2 mb-sm-0" href="{{ route('login') }}">Login</a>
                    </div>
                </div>
    ...
    <footer class="py-5 bg-light">
        ...
        <div class="mb-5"></div>
        <div class="container">
            <p class="text-center">All rights reserved © Programming with Towfik 2023-2024</p>
        </div>
    </footer>
@endsection
